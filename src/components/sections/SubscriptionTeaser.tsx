    ...
    <section className="container-page py-20 sm:py-28">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-cocoa-600 px-6 py-14 sm:px-12 sm:py-20">
        ...
        <div className="relative z-10 mx-auto max-w-xl text-center">
          <Reveal>
            <span className="eyebrow bg-cream-100/10 text-gold-500">The Bite Box</span>
            <h2 className="mt-5 font-display text-3xl font-bold text-cream-100 sm:text-4xl">
              Never run out of your sweet escape
            </h2>
            <p className="mt-4 text-cream-200/80">
              Subscribe to a monthly Bite Box, mix your favorite flavors, and save up to 24%
              versus one-off orders. Skip, swap, or cancel anytime.
            </p>
          </Reveal>

          <Reveal delay={0.1} className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-cream-200/90">
            {['Custom flavor mix', '30-day fresh delivery', 'Cancel anytime'].map((perk) => (
